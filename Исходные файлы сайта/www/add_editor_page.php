...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Добавление нового редактора</title>
		<style>
			body {
				background: #F5F5DC;
				margin: 0;
	...
	<body>
		...
		<div class="categories">	
			<table class="categories">
				...
				<tr>
					<td class="categorie">
						<a href = "add_editor_page.php?login=<?php echo $_GET['login']?>" class="select_categorie">Добавить редактора</a>
					</td>
				</tr>
			</table>
  		</div>
  		<div class="add_editor">
			<center><form action="db_functions.php?login=<?php echo $_GET['login']?>" method="POST">
				<p>Введите данные для добаления нового редактора:</p>
				<p>Логин пользователя: <input type="text" name="login_editor"></p>
				<p>Пароль пользователя: <input type="text" name="password_editor"></p>					
				<p>Фамилия пользователя: <input type="text" name="surname_editor"></p>
				<p>Имя пользователя: <input type="text" name="name_editor"></p>					
				<p>Email: <input type="text" name="email_editor"></p><br/>
				<p><input type="submit" name="add_editor" value="Зарегистрировать редактора"></p>
			</form></center>
  		</div>
