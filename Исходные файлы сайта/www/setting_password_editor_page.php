		...
		<div class="categories">	
			<table class="categories">
				<tr>
					<td class="categorie categorie_not_bottom">
						<a href = "setting_password_editor_page.php?login=<?php echo $_GET['login']?>" class="select_categorie">Изменить пароль</a>
					</td>
				</tr>
				<tr>
					<td class="categorie">
						<a href = "setting_data_editor_page.php?login=<?php echo $_GET['login']?>" class="categorie">Данные этого профиля</a>
					</td>
				</tr>
			</table>
  		</div>
  		<div class="update_password">
			<center><form action="db_functions.php?login=<?php echo $_GET['login']?>" method="POST">
				...
				<p><input type="submit" name="update_editor_password" value="Изменить пароль"></p>
			</form></center>
  		</div>
