		...
		<table class="struct menu">
			<tr>
				<td class="element element_not_right">
					<a href = "start_admin_page.php?login=<?php echo $_GET['login']?>" class="select_menu">Главная</a>
				</td>
				<td class="element element_not_right">
		...
		<div class="news">
			<div class="news_block">
				...
				<div class="last_news">
					...
					<p><a class="head_last_news" href="article_only.php?action=start_admin&login=<?php echo $_GET['login']?>&article_id=<?php echo $row["article_id"]?>"><?php echo $row["article_name"];?></a></p>
				</div>
				<?php 
					}
					$index++;
  		...
  		<div class="mainnew">
   			<p class="welcome">Здравствуйте! Вы вошли под профилем администратора</p>
  		<?php
			...
			<div class="main_new">
				...
				<div class="main">
					...
					<p><a class="head_main_news" href="article_only.php?action=start_admin&login=<?php echo $_GET['login']?>&article_id=<?php echo $row["article_id"]?>"><?php echo $row["article_name"];?></a></p>
